    <div id="content-wrapper" class="wall">
      ...
      <section id="content" class="row clearfix">
        <section id="wall-wrapper" class="columns cols-12">
          ...
          <section id="wall-top" class="row clearfix">
            <section id="wall-choise" class="columns cols-12">
              <ul>
                ...
                <section id="wall-img" class="columns cols-2">
                  ...
                  <div class="hover-overlay">
                    <section id="top">
                      ...
                      <p><?php $user = $photo->getUser(); echo $user->getUsername(); ?></p>
                      <p><strong>Datum:</strong> <?= $photo->getCreated()->format('d-m-Y' ); ?></p>
                    </section>
                    <figure>
